...
export async function userConfigControllerGetConfig(
...
export async function userConfigControllerUpsertConfig(body: LF.CreateUserConfigDto,
  options ?: {[key: string]: any}
) {
  return request<LF.UserConfigEntity>('/api/v1/user-config', {
  method: 'PUT',
...
export async function userConfigControllerUpdateConfig(body: LF.UpdateUserConfigDto,
  options ?: {[key: string]: any}
) {
  return request<LF.UserConfigEntity>('/api/v1/user-config', {
  method: 'PATCH',
...
export async function userConfigControllerResetConfig(
  options ?: {[key: string]: any}
) {
